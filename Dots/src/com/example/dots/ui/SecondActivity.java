...
import com.example.dots.R.layout;
import com.example.dots.view.DrawView;
...
public class SecondActivity extends Activity implements OnClickListener {
	...
	private EditText edt_add_first, edt_add_second, edt_delete_first,
			edt_delete_second, edt_check_first, edt_check_second;
	...
	private void init() {
		...
		dw.setSize(intent.getIntExtra("rows", 0),
				intent.getIntExtra("columns", 0));
